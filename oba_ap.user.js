...
(function () {
  ...
  let m_playingNow = document.querySelector(".course-player-header");
  if (!m_current.getElementsByClassName("course-player-video-link").item(0).innerText.includes(m_playingNow.innerText)) {
    console.log("Şu an oynatılan video en son videodan farklı, geçiliyor...");
    m_current.children.item(0).click();
  }
